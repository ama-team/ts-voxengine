...
declare global {
    export interface Call {
        ...
        // fallback overload in case additional events will be added and
        // typings would be out of sync
        ...
        /**
         * Start sending media (voice and video) from this call to media
         * unit specified in targetMediaUnit. The target call has to be
         * {@link CallEvents.Connected} earlier. IMPORTANT: each call object
         * can send media to any number of other calls (media units), but
         * can receive only one audio stream. A new incoming stream always
        ...
        /**
         * Stop sending media (voice and video) from this call to media unit
         * specified in targetMediaUnit.
         *
         * @param targetMediaUnit Media unit that will not receive media
         * from this call anymore.
         */
